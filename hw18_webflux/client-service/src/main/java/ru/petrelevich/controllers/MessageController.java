...
public class MessageController {
    ...
    public void getMessage(@DestinationVariable("roomId") String roomId, Message message) {
        ...
        if (!Objects.equals(roomId, MAGIC_ROOM)) {
        ...
        template.convertAndSend(String.format("%s%s", TOPIC_TEMPLATE, MAGIC_ROOM), new Message(HtmlUtils.htmlEscape(message.messageStr())));
    }
    ...
    public void handleSessionSubscribeEvent(SessionSubscribeEvent event) {
        ...
        if(roomId == Long.parseLong(MAGIC_ROOM)) {
            getAllMessages()
